...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof TheaterToggle === 'undefined' ? 'undefined' : _typeof(TheaterToggle), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.theaterSwitch), 'function', 'videojs-theater-toggle plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-theater-toggle'), 'the plugin adds a class to the player');
});
